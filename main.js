...
function setup() {
  ...
  EntityList.push(new Square(0, CANVAS_HEIGHT - 81, 80, Colors.all[0], true));
  EntityList.push(new Square(80, CANVAS_HEIGHT - 81, 80, Colors.all[1], true));
  EntityList.push(new Square(160, CANVAS_HEIGHT - 81, 80, Colors.all[2], true));
  EntityList.push(new Square(240, CANVAS_HEIGHT - 81, 80, Colors.all[3], true));
  EntityList.push(new Square(320, CANVAS_HEIGHT - 81, 80, Colors.all[4], true));
